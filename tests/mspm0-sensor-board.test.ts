...
describe("MSPM0 Adafruit sensor board source", () => {
  ...
  test("implements all ten sensor selections and their required support parts", async () => {
    ...
    const sensorCases = {
      "adafruit-bno085": "Bno085Circuit",
      "adafruit-mcp9808": "Mcp9808Circuit",
      "adafruit-bno055": "Bno055Circuit",
      "adafruit-sht45": 'Sht4xCircuit sensor="sht45"',
      "adafruit-sht41": 'Sht4xCircuit sensor="sht41"',
      "adafruit-lis3dh": "Lis3dhCircuit",
      "adafruit-lsm6dsox": "Lsm6dsoxCircuit",
      "adafruit-aht20": "Aht20Circuit",
      "adafruit-vl53l4cd": "Vl53l4cdCircuit",
      "adafruit-veml7700": "Veml7700Circuit",
    } as const
    ...
    const aht20 = section(source, "const Aht20Circuit", "const Vl53l4cdCircuit")
  ...
  test("preserves corrected imported pin maps and SHT4x copper rules", async () => {
    ...
    expect(source).toContain('sensorId === "adafruit-aht20"')
    expect(source).toContain(
