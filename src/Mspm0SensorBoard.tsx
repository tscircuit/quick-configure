...
import { adafruitSensors, type AdafruitSensorId } from "./adafruit-sensor-data"
import { SmdUsbC } from "./SmdUsbC"

export interface Mspm0SensorBoardProps {
  sensor: AdafruitSensorId
}
...
// Exact 5.2 mm x 3.8 mm BNO08x land pattern from Adafruit's BNO08x PCB.
const bno085Pads = [
...
export const Mspm0SensorBoard = ({
  ...
  const sensor = adafruitSensors[sensorId]
  const sensorNeedsCopperKeepout =
    sensorId === "adafruit-sht41" ||
    sensorId === "adafruit-sht45" ||
    sensorId === "adafruit-aht20"
  ...
  return (
    ...
    >
      ...
      */}
      ...
      />
      <silkscreentext
        text="QUICK CONFIGURE • ADAFRUIT SENSOR"
        pcbX={5}
        pcbY={28}
        fontSize="0.65mm"
      />
