...
// Board-space exits: CPU goes left, RAM goes right. A half turn also
// swaps each edge's top/bottom track order; these are not just side renames.
export const socBusFanoutDirections = {
  DDR_BYTE0: "leftside_bottom",
  DDR_BYTE1: "leftside_top",
  DDR_ADDR_CTRL: "leftside_center",
  DDR_CLOCK: "leftside_bottom",
  DDR_DQS0: "leftside_bottom",
  DDR_DQS1: "leftside_center",
  DDR_RESET: "leftside_center",
  DDR_DMI0: "leftside_bottom",
  DDR_DMI1: "leftside_top",
} as const
export const dramBusFanoutDirections = {
  DDR_BYTE0: "rightside_center",
  DDR_BYTE1: "rightside_center",
  DDR_ADDR_CTRL: "rightside_center",
  DDR_CLOCK: "rightside_bottom",
  DDR_DQS0: "rightside_bottom",
  DDR_DQS1: "rightside_center",
  DDR_RESET: "rightside_bottom",
  DDR_DMI0: "rightside_bottom",
  DDR_DMI1: "rightside_center",
} as const

export default function Am62lLpddr4Left({
  ...
  return (
    ...
    >
      ...
      <pcbnotetext
        ...
        pcbY={-14}
        fontSize={0.7}
        text="AM62L · LPDDR4 · Left · Coordinated fanouts"
      />
    </board>
  )
}
