...
// Board-space exits: CPU goes down, RAM goes up. Compared with Top,
// the half turn also swaps the left/right track order on each edge.
export const socBusFanoutDirections = {
  DDR_BYTE0: "bottomside_right",
  DDR_BYTE1: "bottomside_left",
  DDR_ADDR_CTRL: "bottomside_center",
  DDR_CLOCK: "bottomside_right",
  DDR_DQS0: "bottomside_right",
  DDR_DQS1: "bottomside_center",
  DDR_RESET: "bottomside_center",
  DDR_DMI0: "bottomside_right",
  DDR_DMI1: "bottomside_left",
} as const
export const dramBusFanoutDirections = {
  DDR_BYTE0: "topside_center",
  DDR_BYTE1: "topside_center",
  DDR_ADDR_CTRL: "topside_center",
  DDR_CLOCK: "topside_right",
  DDR_DQS0: "topside_right",
  DDR_DQS1: "topside_center",
  DDR_RESET: "topside_right",
  DDR_DMI0: "topside_right",
  DDR_DMI1: "topside_center",
} as const

export default function Am62lLpddr4Bottom({
  ...
  return (
    ...
    >
      ...
      <autoroutingphase
        autorouter={{
          algorithmFn: createCoordinatedDdrGlobalAutorouter(routingState, 270),
        }}
      />
      ...
      <breakout
        ...
        autorouter={{
          preset: "fanout",
          implicitBreakoutPointSolverFn: bottomDdrWindingSolver,
      ...
      >
        <Am62l32 name="U1" pcbRotation={270} noSchematicRepresentation />
      ...
      <breakout
        ...
        autorouter={{
          ...
          algorithmFn: createDdrFanoutAutorouter(
            ...
            { referenceRotation: 270, maxLayerCombinations: 1 },
            routingState,
          ),
        }}
        fanoutRoutingLayers={[...POWER_FANOUT_SIGNAL_LAYERS]}
      ...
      >
        <Mt53e1g16d1zw name="U2" pcbRotation={0} noSchematicRepresentation />
      ...
      {AM62L_DDR_DECOUPLING_CAPACITORS.map((capacitor) => (
        <Fragment key={capacitor.name}>
          <capacitor
            ...
            pcbRotation={(270 + capacitor.pcbRotation) % 360}
          />
          <trace
